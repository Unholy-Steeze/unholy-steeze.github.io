...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // CONSOLE EASTER EGG
    // ============================================
    console.log('%c🔥 Unholy Steeze', 'font-size: 24px; font-weight: bold; color: #8B00FF; text-shadow: 0 0 10px rgba(139, 0, 255, 0.8);');
    console.log('%cBenvenuto nella nostra community Discord!', 'font-size: 14px; color: #FF00FF;');
    console.log('%chttps://discord.gg/mehHRpqC2z', 'font-size: 12px; color: #7289da;');
});
